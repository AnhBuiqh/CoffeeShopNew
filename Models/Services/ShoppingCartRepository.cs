...
namespace TH01.Models.Services
{
    public class ShoppingCartRepository : IShoppingCartRepository
    {
        ...
        public ShoppingCartRepository(TH01DbContext dbContext)
        {
        ...
        public static ShoppingCartRepository GetCart(IServiceProvider services)
        {
            ...
            TH01DbContext context = services.GetService<TH01DbContext>() ?? throw new Exception("Error initializing TH01dbcontext");
